...
public class SettingsGui extends LightweightGuiDescription {
    public static final Texture SUPER_OFF_IMAGE = new Texture(Clicker.id("textures/image_off.png"));
    public static final Texture SUPER_ON_IMAGE = new Texture(Clicker.id("textures/image_on.png"));
